...
This document records the behavior of beads (`bd`) dependency relationships, specifically how they affect the `bd ready` command. These findings inform how bd-tui should display and interpret dependencies.
